...
class GoodsTypeController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        $queries =  GoodsType::searchByConditions($conditions); //検索
        ...
        return view('MemberManagement.goodstypes.index', $requestData);
    }
    ...
    */
     ...
     * 指定したリソースを表示します。
     *
     * @param  \App\Models\GoodsType  $goodsType
     * @return \Illuminate\Http\Response
     */
