...
class MusicalInstrumentController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        $musicalInstruments = MusicalInstrument::get();
        ...
        $queries =  MusicalInstrument::searchByConditions($conditions); //検索
        ...
        return view('MemberManagement.musicalInstruments.index', $requestData);
    }
    ...
    */
     ...
     * 指定したリソースを表示します。
     *
     * @param  \App\Models\MusicalInstrument  $musicalInstrument
     * @return \Illuminate\Http\Response
     */
