...
class BandMembers extends Model
{
    ...
    */
    ...
    // クラスに問題メンバー判断処理を追加 フラグを持たせる
    // 定数はクラスの中の上に書くのでここに設置
    const CLAIMER_FLAG_ON = 1;
    ...
    */
    ...
    // eventを追加 問題メンバー登録時にはメールが来る
    protected $dispatchesEvents = [
        'created' => \App\Events\ClaimerInComming::class,
    ];


    // 問題メンバー判断処理 フラグの設定
    // 新規メンバー登録時に 問題メンバーフラグ 1 が登録されたら、問題メンバーが来たとして管理者に 通知メールが送られます。
    public function isClaimer(): bool
    {
        return $this->claimer_flag == BandMembers::CLAIMER_FLAG_ON;
    }
