...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12" style="user-select: auto;">
            <div class="card" style="user-select: auto;">
                <div class="card-header" style="user-select: auto;"><i class="fa fa-align-justify" style="user-select: auto;"></i> イベント参加バンド</div>
                <div class="card-body" style="user-select: auto;">
                    <table class="table table-responsive-sm table-bordered table-striped table-sm" style="user-select: auto;">
                        ...
                        <tbody style="user-select: auto;">
                            ...
                            <tr style="user-select: auto;">
                                <td style="user-select: auto;">{{$entrie->band_id}} {{$entrie->bandName}}</td>
                                <td style="user-select: auto;">{{$entrie->event_id}}</td>
                                @endforeach
                            </tr>
                        </tbody>
                    </table>
