 ...
 <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
     ...
     <ul class="c-sidebar-nav">
         <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('/core"/') }>
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('/core/age') }}">
                 <svg class="c-sidebar-nav-icon">
                     <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
                 </svg> TOP画面</a></li>
         ...
         <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('/core/ticketlists') }}">
                 <svg class="c-sidebar-nav-icon">
                     <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
                 </svg> チケットリスト一覧</a></li>
         ...
         <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('/marble') }}">
                 <svg class="c-sidebar-nav-icon">
                     <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
                 </svg>merble テンプレート</a></li>
         <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('/front/lp/polo') }}">
                 <svg class="c-sidebar-nav-icon">
                     <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
