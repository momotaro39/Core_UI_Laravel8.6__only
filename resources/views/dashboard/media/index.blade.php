                                ...
                                <table class="table table-striped table-bordered datatable">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary file-change-folder-name" atr="{{ $mediaFolder->id }}">
                                                    Rename
                                                </button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button class="btn btn-primary file-move-folder" atr="{{ $mediaFolder->id }}">
                                                    Move
                                                </button>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger file-delete-folder" atr="{{ $mediaFolder->id }}">
                                                    Delete
                                                </button>
                                                @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary file-change-file-name" atr="{{ $media->id }}">
                                                    Rename
                                                </button>
                                            </td>
                                            <td>
                                                <a href="{{ route('media.file.copy', ['id' => $media->id, 'thisFolder' => $thisFolder]) }}" class="btn btn-primary">
                                                    Copy
                                                </a>
                                            </td>
                                            <td>
                                                <button class="btn btn-primary file-move-file" atr="{{ $media->id }}">
                                                    Move
                                                </button>
                                            </td>
                                            <td>
                                                ...
                                                if ($mime[0] === 'image') {
                                                ?>
                                                    <button class="btn btn-success file-cropp-file" atr="{{ $media->id }}">
                                                        Cropp
                                                    </button>
                                                <?php
                                                }
                                            ...
                                            <td>
                                                <button class="btn btn-danger file-delete-file" atr="{{ $media->id }}">
                                                    Delete
                                                </button>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="{{ route('media.folder.move') }}">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="folder" value="{{ $mediaFolder->id }}" class="file-move-folder-radio">
                                                    </td>
                                                    <td>
                                                        {{ $mediaFolder->name }}
                                                    </td>
