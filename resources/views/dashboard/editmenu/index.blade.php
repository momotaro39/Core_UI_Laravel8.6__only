                    ...
                    <div class="card-body">
                        ...
                        function renderDropdownForMenuEdit($data, $role)
                        {
                            if (array_key_exists('slug', $data) && $data['slug'] === 'dropdown') {
                                ...
                                echo '</td>';
                                echo '<td>';
                                echo '<a class="btn btn-primary" href="' . route('menu.show', ['id' => $data['id']]) . '">詳細</a>';
                                echo '</td>';
                                echo '<td>';
                                echo '<a class="btn btn-primary" href="' . route('menu.edit', ['id' => $data['id']]) . '">編集</a>';
                                echo '</td>';
                                echo '<td>';
                                ...
                                for ($i = 0; $i < count($data); $i++) {
                                    if ($data[$i]['slug'] === 'link') {
                                        ...
                                        echo '</td>';
                                        echo '<td>';
                                        echo '<a class="btn btn-primary" href="' . route('menu.show', ['id' => $data[$i]['id']]) . '">詳細</a>';
                                        echo '</td>';
                                        echo '<td>';
                                        echo '<a class="btn btn-primary" href="' . route('menu.edit', ['id' => $data[$i]['id']]) . '">編集</a>';
                                        echo '</td>';
                                        echo '<td>';
                        ...
                        <table class="table table-striped table-bordered datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="{{ route('menu.show', ['id' => $menuel['id']]) }}">詳細</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-primary" href="{{ route('menu.edit', ['id' => $menuel['id']]) }}">編集</a>
                                    </td>
                                    <td>
