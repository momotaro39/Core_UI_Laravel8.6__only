        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-sm btn-primary" type="submit"> ログイン</button>
                        <button class="btn btn-sm btn-danger" type="reset"> リセット</button>
                    </div>
                </div>
                <div class="card">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-sm btn-success" type="submit"> 送信</button>
                        <button class="btn btn-sm btn-danger" type="reset"> リセット</button>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input class="form-control" id="input2-group2" type="email" name="input2-group2"
                                            ...
                                            <button class="btn btn-primary" type="button">送信</button></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group form-actions">
                                <button class="btn btn-sm btn-secondary" type="submit">送信</button>
                            </div>
                        </form>
                    </div>
                </div>
