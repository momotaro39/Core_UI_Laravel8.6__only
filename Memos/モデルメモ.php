 ...
 * @property integer $pre_meeting_cost_plan
 * @property integer $pre_meeting_cost
 * @property integer $pre_travel_cost_plan
 * @property integer $pre_travel_cost
 * @property integer $travel_cost_plan
 * @property integer $travel_cost
 * @property integer $outsourcing_cost_plan
 * @property integer $outsourcing_cost
 * @property integer $material_cost_plan
 * @property integer $material_cost
 * @property string $expenses_note
 * @property string $purchase_note
 * @property boolean $imitsu
...
class ProjectOrder extends Model
{
    ...
    */
    ...
    protected $fillable = [
        'project_id',
        'pre_meeting_cost_plan',
        'pre_meeting_cost',
        'pre_travel_cost_plan',
        'deleted_at'
    ];
    ...
    */
    ...
    protected static function boot()
    {
        ...
        self::creating(function ($mCustomer) {
            return $mCustomer->onCreatingHandler();
        });

        self::updating(function ($mCustomer) {
            return $mCustomer->onUpdatingHandler();
        });
    }
