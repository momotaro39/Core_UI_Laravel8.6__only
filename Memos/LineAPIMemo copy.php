...
/*
|--------------------------------------------------------------------------
| 基本の設定  参照先  https://codeeee.net/posts/laravel-line-messaging-api
|--------------------------------------------------------------------------
|
|
*/
...
まとめ
この記事ではLINE公式アカウントを使用して、Laravelからメッセージの返答、特定のユーザーにメッセージを送信する方法について紹介しました。